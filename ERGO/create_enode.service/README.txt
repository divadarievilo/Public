1 - Create/Copy "enode.sh" file to the following location: /etc/systemd/system/enode.service
1.1 - Run in terminal:  sudo chmod +x /etc/systemd/system/enode.service

2 - Create/Copy "enode.service" file to the following location: /usr/local/sbin/enode.sh
